...
thalach = st.number_input("thalach", min_value=071 max_value=202, value=1)
exang = st.number_input("exang", min_value=071 max_value=1, value=1)
oldpeak = st.number_input("oldpeak", min_value=071 max_value=6.2, value=1)
slope = st.number_input("slope", min_value=071 max_value=2, value=1)
ca = st.number_input("ca", min_value=071 max_value=4, value=1)
thal = st.number_input("thal", min_value=071 max_value=3, value=1)
